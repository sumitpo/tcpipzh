...
\begin{document}
\begin{titlepage} % Suppresses displaying the page number on the
  % title page and the subsequent page counts as page 1
  \newcommand{\HRule}{\rule{\linewidth}{0.5mm}} % Defines a new
  % command for horizontal lines, change thickness here
  ...
  \textsc{\LARGE Institution Name}\\[1.5cm] % Main heading such as
...
% \dopage
% 插入各前置内容
\include{chapters/publisher_note}
\include{chapters/translator_preface}
